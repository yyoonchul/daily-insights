...
DIGEST_LAUNCHD_CODEX_SANDBOX_MODE="${DIGEST_LAUNCHD_CODEX_SANDBOX_MODE:-workspace-write}"
DIGEST_LAUNCHD_CODEX_BYPASS_APPROVALS_AND_SANDBOX="${DIGEST_LAUNCHD_CODEX_BYPASS_APPROVALS_AND_SANDBOX:-false}"
DIGEST_LAUNCHD_LABEL_PREFIX="${DIGEST_LAUNCHD_LABEL_PREFIX:-com.dailyinsights.digest}"
...
label_for() {
  local engine="$1"
  echo "${DIGEST_LAUNCHD_LABEL_PREFIX}.${engine}"
}
